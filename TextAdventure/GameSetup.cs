...
public static class GameSetup
{
    public static Building CreateWorld(bool isAdmin = false)
    {
        ...
        var boven = new Room("De Uitgang", "Je staat voor een grote deur. Ontsleutel hem om te ontsnappen.") { RequiredItem = "Sleutel", RoomId = 2 };
        ...
        boven.AddExit(Direction.s, start);
